...
int main(int argc,char** argv){
     try{
        ...
        if (enor.isEmpty()){
            cout <<"There is no competition in the file, file is empty!\n";
        }
        else if (pr.found()){
            cout << "For each competition in "<< pr.elem().year <<" year, at most 3 correct solutions were obtained in Fortran " <<"\n";
        }
        else{
